...
- Tax UI changes must preserve an auditable trace from displayed gain/tax back to sale transaction, FIFO source lot, FX conversion, tax bucket reason, and formula; do not expose tax totals without a drilldown path.
