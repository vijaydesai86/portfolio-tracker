...
- Dashboard analytics for linked holdings, INR allocation, INR XIRR with historical FX, invested/income/fee totals in INR, asset-kind totals, India/US totals, source totals, and institution/AMC-style totals.
